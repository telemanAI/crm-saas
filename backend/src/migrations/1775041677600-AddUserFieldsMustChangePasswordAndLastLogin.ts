...
export class AddUserFieldsMustChangePasswordAndLastLogin1775041677600 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // 3. USERS — aggiungi colonne solo se non esistono
        ...
        // 5. IMPORT_TEMPLATES — ricrea colonne safe (solo se non esistono già con il tipo giusto)
        ...
        // 6. IMPORT_JOBS — ricrea colonne safe
