  ...
  return (
    <OperatorLayout title="Dettaglio pratica mobile">
      <div className="max-w-4xl mx-auto">
        <Link href="/operator/practices/mobile" className="inline-flex items-center gap-2 text-slate-400 hover:text-white mb-4 text-sm">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 mb-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">
                  {practice.offerName || 'Pratica mobile'}
                </h1>
            ...
            <div className="flex items-center gap-2">
              <Link href={`/operator/practices/mobile/new?edit=${practice.id}`}>
                <button className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-sm font-medium">
          ...
          <div className="flex items-center gap-3 mt-4">
            <select
              ...
              onChange={(e) => updateOpStatus(e.target.value)}
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6">
      <div className="flex items-center gap-2 mb-4">
        <Icon className="w-5 h-5 text-indigo-400" weight="duotone" />
