...
export default function InviteAccept() {
  ...
  const openSocial = (provider: 'google' | 'facebook') => {
    // Dopo callback social, il backend potrebbe portare l'utente a /auth/complete-registration con inviteToken precaricato
    // Per semplicità: l'utente prima si logga con social, poi torna sull'invite-link (token persistente nell'URL).
...
function Input({ icon, type, placeholder, value, onChange, required, testid }: any) {
  return (
